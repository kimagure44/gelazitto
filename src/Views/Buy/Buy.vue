...
const dayjs = require("dayjs"); // Intenta no usar dependencias externas. Javascript es muy completo y tiene suficiente capacidad para hacer lo que queremos.
...
export default {
  ...
  methods: {
    ...
    async createOrder() {
      // Intenta que las evaluaciones sean siempre positivas. Es mas facil de leer y mantener la lógica si usamos siempre la evaluación positiva (true).
      // if (!this.$refs.form.validate()) return;
      // Si es válido lo haces
