...
export default {
  ...
  methods: {
    ...
    async loadData() {
      try {
        // Cualquier cosa que sea texto o valores fijos debería ir en un fichero aparte. Por ejemplo la url de la api.
  ...
  mounted() {
    /* 
		Cualquier lógica que hagamos intentar separar en métodos.
		Mejor para los test, escalabilidad y mantenibilidad.
		Intentar mantener el principio de unica responsabilidad.
		Puedes buscar información sobre CLEAN CODE, SOLID y DRY en internet.
		*/
    this.loadData();
  },
};
